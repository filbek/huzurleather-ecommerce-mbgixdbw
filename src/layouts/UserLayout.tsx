...
const UserLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Orders', href: '/dashboard/orders', icon: 'bi-bag-check' },
    { name: 'Profile', href: '/dashboard/profile', icon: 'bi-person' },
    { name: 'Addresses', href: '/dashboard/addresses', icon: 'bi-geo-alt' },
    { name: 'Wishlist', href: '/dashboard/wishlist', icon: 'bi-heart' },
  ];
          ...
          <div className="h-0 flex-1 overflow-y-auto pt-5 pb-4">
            <div className="flex flex-shrink-0 items-center px-4">
              <Link to="/" className="flex items-center space-x-2">
                ...
                <span className="text-xl font-serif font-semibold text-leather-900">Luxe Leather</span>
              </Link>
            </div>
